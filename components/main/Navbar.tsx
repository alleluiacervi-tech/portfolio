      ...
      <div className="mx-auto w-full max-w-7xl rounded-2xl border border-[#7042f861] bg-[#030014cc] shadow-[0_10px_35px_rgba(42,14,97,0.38)] backdrop-blur-xl">
        <div className="flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-2">
            <a
              href="#contact"
              className="hidden rounded-full border border-[#8b74ff]/45 bg-[#8b74ff]/10 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#8b74ff]/20 sm:inline-flex"
            >
              Contact
            </a>
            <button
