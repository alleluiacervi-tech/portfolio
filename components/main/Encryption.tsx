  ...
  return (
    <section className="section-shell">
      <motion.div
        ...
        className="panel-card panel-card-hover relative overflow-hidden px-5 py-5 md:px-7 md:py-6"
      >
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_85%_15%,rgba(139,116,255,0.22),transparent_42%)]" />
        <div className="relative grid gap-5 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold leading-tight text-white md:text-[32px]">
            ...
            <div className="mt-4 flex flex-wrap gap-2.5">
              {SECURITY_HIGHLIGHTS.map((highlight) => (
                <span
                  key={highlight}
                  className="rounded-full border border-[#8b74ff]/45 bg-[#8b74ff]/10 px-3 py-1 text-[11px] uppercase tracking-[0.12em] text-[#ddd3ff]"
                >
                  {highlight}
                </span>
              ))}
          ...
          <div className="relative overflow-hidden rounded-xl border border-[#8b74ff]/35 bg-[#090321]">
            <video
              loop
              muted
              autoPlay
